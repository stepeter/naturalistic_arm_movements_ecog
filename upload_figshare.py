...
import json
import os
import glob,natsort,pdb

import requests
from requests.exceptions import HTTPError

'''
Method for remotely uploading data to figshare. Modified code from figshare API documentation: https://docs.figshare.com/#upload_files_example_upload_on_figshare
'''

BASE_URL = 'https://api.figshare.com/v2/{endpoint}'
TOKEN = '<add_personal_figshare_token>
CHUNK_SIZE = 1048576

FILE_PATH = '.../naturalistic_reaches/*.fif'
TITLE = 'Naturalistic reach ECoG data'
...
def main():
    ...
    files_all = natsort.natsorted(glob.glob(FILE_PATH))
    files_all = files_all[27:] #upload in parts
